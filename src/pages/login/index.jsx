            ...
            <div className="login">
                <div className="content">
                    ...
                    <div className="input-container">
                        <input type="email" id="email" className='input-field' onClick={() => inputAtivado('email')}/>
                        <label htmlFor='email' className="input-label">Email</label>
                    </div>
                    <div className="input-container">
                        <input type="password" id="senha" className='input-field' onClick={() => inputAtivado('senha')}/>
                        <label htmlFor='senha' className="input-label">Senha</label>
                        <label htmlFor='senha' className='eye-label' onClick={eyeFunctions}><i className="ri-eye-off-line"></i></label>
                    </div>

                    <button onClick={fazerLogin}>Entrar</button>
                </div>
                <span className='creditos' style={{opacity: 0.8}}>Desenvolvido por <a href="https://www.instagram.com/hnuciatelli_/" target='_blank'>@hnuciatelli_</a></span>
            </div>
